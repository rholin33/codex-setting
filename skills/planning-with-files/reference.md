...
**Solution:** Re-read `Task/task_plan.md` before each decision. Goals appear in the attention window.

```
Start of context: [Original goal - far away, forgotten]
...many tool calls...
End of context: [Recently read Task/task_plan.md - gets ATTENTION!]
```
...
|------|---------|--------------|--------------|
| `Task/task_plan.md` | Phase tracking, progress | Task start | After completing phases |
| `Task/findings.md` | Discoveries, decisions | After ANY discovery | After viewing images/PDFs |
| `Task/progress.md` | Session log, what's done | At breakpoints | Throughout session |
